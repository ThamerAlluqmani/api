...
// under testing
Route::post('tasks/{taskId}/upload-file' ,'App\Http\Controllers\API\FileController@upload' );
Route::delete('files/{file}' ,'App\Http\Controllers\API\FileController@destroy' );
